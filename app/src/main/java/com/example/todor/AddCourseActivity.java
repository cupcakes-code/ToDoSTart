...
public class AddCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sdEt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddCourseActivity.this, android.R.style.Theme_DeviceDefault_Dialog, sDatesetListener, year, mnth, day);
        ...
        edEt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddCourseActivity.this, android.R.style.Theme_DeviceDefault_Dialog, eDatesetListener, year, mnth, day);
                datePickerDialog.show();
    ...
    public void addNewCourse(View view) {
        ...
        appDatabase.courseDao().insertNewCourse(course);
        Toast.makeText(this, "New course inserted successfully", Toast.LENGTH_SHORT).show();
        finish();
    }
}